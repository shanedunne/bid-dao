    ...
    return(
        <div className="home">
            <div className={style.homeDiv}>
                ...
                <p className={style.para}><strong>Bid Dao</strong> is a DAO generating platform modeled to provide closed door DAOs to a group of friends or other organisations. Users can quickly mint a custom ERC20 and define governance conditions without writing any code</p>
