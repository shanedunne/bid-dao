...
contract Token {
    ...
    // dao capacity set in front end
    uint public daoMaxSize;

    // counts members array
    uint public daoCounter;

    // used to get balance of group members
    address[] public members;
    
    // approved list - may not be required
    ...
    constructor(address _owner, string memory _name_, string memory _symbol_, uint _daoMaxSize, uint _tokenTotalSupply) {
        ...
        totalSupply = _tokenTotalSupply * 1000000000000000000;
        owner = _owner;
    ...
    function addMembersToApprovedList(address _newMember) external {
